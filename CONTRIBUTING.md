...
# Contributing to World of Aphasya

First off, thank you for being here. World of Aphasya is built by a community
...
[Discord](https://discord.com/invite/worldofaphasya) and someone will be happy to help.
...
- **Code.** Fix a bug, add a feature, or improve performance. Issues labeled
  ...
  and [`help wanted`](https://github.com/mgocbr3/world-of-aphasya/labels/help%20wanted)
...
- **Bug reports and feature ideas.** Open an [issue](https://github.com/mgocbr3/world-of-aphasya/issues/new/choose).
...
- **Lockfile.** The lockfile is `pnpm-lock.yaml` (pnpm 10 / lockfileVersion 9).
  ...
  degenerate-normal shader guard, the released-program retention and the count 0
  instanced-mesh render-list skip alike (`tests/three_compile_async_patch.test.ts`
...
World of Aphasya ships in many languages. Every player-visible string must be a
...
on [Discord](https://discord.com/invite/worldofaphasya) and we'll help you wire it up. Native
and fluent speakers are especially welcome. Good translations make the game feel
like home for players everywhere.

## Reporting bugs and requesting features

Please use the [issue templates](https://github.com/mgocbr3/world-of-aphasya/issues/new/choose):

- **Bug report.** Search [existing issues](https://github.com/mgocbr3/world-of-aphasya/issues)
...
[community Discord](https://discord.com/invite/worldofaphasya). No question is too small, and
...
- it includes at minimum a perpetual, royalty-free grant to Levy Street to use
  the assets commercially in World of Aphasya, including official releases
...
Thank you for contributing to World of Aphasya. We can't wait to see what you
build with us.
