...
3. MEMORY SCAN. Read project MEMORY.md (path redacted)
   ...
   or emojis anywhere; live site world-of-aphasya.pixlland.com with test creds fernando/turbo564
...
Drive world-of-aphasya.pixlland.com (or local `npm run dev` + `npm run server`) via Playwright
