...
# Contribuire a World of Aphasya

Prima di tutto, grazie di essere qui. World of Aphasya è costruito da una
...
[Discord](https://discord.com/invite/worldofaphasya) e qualcuno sarà felice di darti una mano.
...
- **Codice.** Correggi un bug, aggiungi una funzionalità o migliora le prestazioni.
  ...
  e [`help wanted`](https://github.com/mgocbr3/world-of-aphasya/labels/help%20wanted)
...
- **Segnalazioni di bug e idee per nuove funzionalità.** Apri una
  [issue](https://github.com/mgocbr3/world-of-aphasya/issues/new/choose).
...
World of Aphasya è distribuito in molte lingue. Ogni stringa visibile ai
...
terminologia, avvia una discussione su [Discord](https://discord.com/invite/worldofaphasya) e ti
...
Per favore usa i [modelli di issue](https://github.com/mgocbr3/world-of-aphasya/issues/new/choose):

- **Segnalazione di bug.** Cerca prima tra le
  [issue esistenti](https://github.com/mgocbr3/world-of-aphasya/issues) per
...
[Discord della comunità](https://discord.com/invite/worldofaphasya). Nessuna domanda è troppo
...
[Termini di Servizio](https://world-of-aphasya.pixlland.com/terms) regolano il gioco
ospitato che gestiamo su world-of-aphasya.pixlland.com (account, condotta, oggetti
virtuali) e non limitano i diritti che la Licenza MIT concede a te o a chiunque
altro su questo codice. I nomi e il marchio "World of Aphasya" e "Levy Street"
...
- includa come minimo una concessione perpetua e senza royalty a Levy Street per
  usare gli asset commercialmente in World of Aphasya, incluse le release
...
Grazie per aver contribuito a World of Aphasya. Non vediamo l'ora di scoprire
