...
# Đóng góp cho World of Aphasya

Trước hết, cảm ơn bạn đã có mặt ở đây. World of Aphasya được xây dựng bởi một
...
[Discord](https://discord.com/invite/worldofaphasya) và sẽ có người sẵn lòng giúp đỡ.
...
- **Mã nguồn.** Sửa một lỗi, thêm một tính năng, hoặc cải thiện hiệu năng. Các vấn
  ...
  và [`help wanted`](https://github.com/mgocbr3/world-of-aphasya/labels/help%20wanted)
...
- **Báo cáo lỗi và ý tưởng tính năng.** Hãy mở một [issue](https://github.com/mgocbr3/world-of-aphasya/issues/new/choose).
...
World of Aphasya được phát hành bằng nhiều ngôn ngữ. Mọi chuỗi hiển thị với
...
hãy bắt đầu một chủ đề trên [Discord](https://discord.com/invite/worldofaphasya) và chúng tôi sẽ
...
Xin hãy sử dụng [các mẫu issue](https://github.com/mgocbr3/world-of-aphasya/issues/new/choose):

- **Báo cáo lỗi.** Hãy tìm trong [các vấn đề hiện có](https://github.com/mgocbr3/world-of-aphasya/issues)
...
[Discord cộng đồng](https://discord.com/invite/worldofaphasya). Không có câu hỏi nào là quá nhỏ,
...
- nó bao gồm tối thiểu một sự cho phép vĩnh viễn, miễn phí bản quyền dành cho Levy
  ...
  Aphasya, bao gồm các bản phát hành chính thức và cửa hàng trong trò chơi.
...
Cảm ơn bạn đã đóng góp cho World of Aphasya. Chúng tôi rất nóng lòng muốn thấy
