...
# Mitwirken an World of Aphasya

Zuallererst: Danke, dass du hier bist. World of Aphasya wird von einer
...
auf [Discord](https://discord.com/invite/worldofaphasya) nach, und jemand hilft dir gerne weiter.
...
- **Code.** Behebe einen Fehler, füge eine Funktion hinzu oder verbessere die
  ...
  und [`help wanted`](https://github.com/mgocbr3/world-of-aphasya/labels/help%20wanted)
...
World of Aphasya erscheint in vielen Sprachen. Jede spielersichtbare
...
sprechen, starte einen Thread auf [Discord](https://discord.com/invite/worldofaphasya), und wir
...
Bitte verwende die
[Issue-Vorlagen](https://github.com/mgocbr3/world-of-aphasya/issues/new/choose):

- **Fehlermeldung.** Durchsuche zuerst die
  [vorhandenen Issues](https://github.com/mgocbr3/world-of-aphasya/issues),
...
[Community-Discord](https://discord.com/invite/worldofaphasya). Keine Frage ist zu klein, und
...
[Nutzungsbedingungen](https://world-of-aphasya.pixlland.com/terms) regeln das von uns
betriebene gehostete Spiel auf world-of-aphasya.pixlland.com (Accounts, Verhalten,
virtuelle Gegenstände) und schränken die Rechte nicht ein, die die MIT License dir
oder anderen an diesem Code gibt. Die Namen und das Branding "World of Aphasya"
...
- sie enthält mindestens eine dauerhafte, lizenzgebührenfreie Erlaubnis für Levy
  Street, die Assets kommerziell in World of Aphasya zu verwenden,
...
Danke, dass du an World of Aphasya mitwirkst. Wir können es kaum erwarten, zu
