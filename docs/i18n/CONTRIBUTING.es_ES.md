...
# Cómo contribuir a World of Aphasya

Antes de nada, gracias por estar aquí. World of Aphasya lo construye una
...
[Discord](https://discord.com/invite/worldofaphasya) y alguien estará encantado de echarte una
mano.
...
- **Informes de fallos e ideas de funcionalidades.** Abre una
  [incidencia](https://github.com/mgocbr3/world-of-aphasya/issues/new/choose).
...
World of Aphasya se distribuye en muchos idiomas. Cada cadena visible para el
...
abre un hilo en [Discord](https://discord.com/invite/worldofaphasya) y te ayudaremos a montarlo.
...
Por favor, usa las
[plantillas de incidencia](https://github.com/mgocbr3/world-of-aphasya/issues/new/choose):

- **Informe de fallo.** Busca primero entre las
  [incidencias existentes](https://github.com/mgocbr3/world-of-aphasya/issues)
...
- incluya como mínimo una cesión perpetua y libre de regalías a Levy Street para usar
  los recursos comercialmente en World of Aphasya, incluidas las publicaciones
...
Gracias por contribuir a World of Aphasya. Estamos deseando ver lo que
