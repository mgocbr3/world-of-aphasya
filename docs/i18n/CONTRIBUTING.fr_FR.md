...
# Contribuer à World of Aphasya

Avant tout, merci d'être là. World of Aphasya est construit par une communauté
...
clair, demandez sur [Discord](https://discord.com/invite/worldofaphasya) et quelqu'un se fera un
...
- **Le code.** Corrigez un bug, ajoutez une fonctionnalité ou améliorez les
  ...
  et [`help wanted`](https://github.com/mgocbr3/world-of-aphasya/labels/help%20wanted)
...
- **Les rapports de bugs et les idées de fonctionnalités.** Ouvrez un [ticket](https://github.com/mgocbr3/world-of-aphasya/issues/new/choose).
...
World of Aphasya est disponible dans de nombreuses langues. Chaque texte visible
...
terminologie, lancez un fil sur [Discord](https://discord.com/invite/worldofaphasya) et nous vous
...
Merci d'utiliser les [modèles de ticket](https://github.com/mgocbr3/world-of-aphasya/issues/new/choose) :

- **Rapport de bug.** Cherchez d'abord parmi les [tickets existants](https://github.com/mgocbr3/world-of-aphasya/issues)
...
[Discord de la communauté](https://discord.com/invite/worldofaphasya). Aucune question n'est trop
...
[Conditions d'utilisation](https://world-of-aphasya.pixlland.com/terms) régissent le jeu
hébergé que nous exploitons sur world-of-aphasya.pixlland.com (comptes, conduite, objets
virtuels) et ne restreignent pas les droits que la Licence MIT vous donne, à vous ou
à quiconque, sur ce code. Les noms et l'identité visuelle « World of Aphasya » et
...
- elle inclue au minimum une concession perpétuelle et libre de redevances à Levy
  Street pour utiliser les ressources commercialement dans World of Aphasya, y
...
Merci de contribuer à World of Aphasya. Nous avons hâte de voir ce que vous
