...
Tout d'abord, merci d'être ici. World of Aphasya est bâti par une communauté
...
demandez sur [Discord](https://discord.com/invite/worldofaphasya) et quelqu'un se fera un
...
- **Traductions.** Aidez les joueurs du monde entier en améliorant ou en
  ...
  lancer.
- **Signalements de bogues et idées de fonctionnalités.** Ouvrez un [ticket](https://github.com/mgocbr3/world-of-aphasya/issues/new/choose).
...
World of Aphasya est offert en plusieurs langues. Chaque chaîne visible par
...
terminologie, lancez un fil sur [Discord](https://discord.com/invite/worldofaphasya) et nous
...
Veuillez utiliser les [gabarits de tickets](https://github.com/mgocbr3/world-of-aphasya/issues/new/choose) :

- **Signalement de bogue.** Cherchez d'abord parmi les [tickets existants](https://github.com/mgocbr3/world-of-aphasya/issues)
...
[Discord de la communauté](https://discord.com/invite/worldofaphasya). Aucune question n'est
...
hébergé que nous exploitons à world-of-aphasya.pixlland.com (comptes, conduite, objets
virtuels) et ne restreignent pas les droits que la licence MIT vous donne, à vous
ou à quiconque, sur ce code. Les noms et l'image de marque « World of Aphasya »
...
- elle inclue au minimum une concession perpétuelle et libre de redevances à Levy
  Street pour utiliser les ressources commercialement dans World of Aphasya,
