...
# Bidra till World of Aphasya

Först och främst, tack för att du är här. World of Aphasya byggs av en
...
[Discord](https://discord.com/invite/worldofaphasya) så hjälper någon dig gärna.
...
- **Kod.** Rätta en bugg, lägg till en funktion eller förbättra prestandan. Issues
  ...
  och [`help wanted`](https://github.com/mgocbr3/world-of-aphasya/labels/help%20wanted)
...
- **Buggrapporter och funktionsidéer.** Öppna ett [issue](https://github.com/mgocbr3/world-of-aphasya/issues/new/choose).
...
World of Aphasya levereras på många språk. Varje spelarsynlig sträng måste
...
starta en tråd på [Discord](https://discord.com/invite/worldofaphasya) så hjälper vi dig att
...
Använd [issue-mallarna](https://github.com/mgocbr3/world-of-aphasya/issues/new/choose):

- **Buggrapport.** Sök bland [befintliga issues](https://github.com/mgocbr3/world-of-aphasya/issues)
...
[gemenskapens Discord](https://discord.com/invite/worldofaphasya). Ingen fråga är för liten, och
...
[användarvillkor](https://world-of-aphasya.pixlland.com/terms) styr det värdbaserade
spelet vi driver på world-of-aphasya.pixlland.com (konton, uppförande, virtuella föremål)
och begränsar inte de rättigheter MIT-licensen ger dig eller någon annan i den här
koden. Namnen och varumärkena "World of Aphasya" och "Levy Street" omfattas
...
- den minst innefattar en evig, royaltyfri rätt för Levy Street att använda
  tillgångarna kommersiellt i World of Aphasya, inklusive officiella releaser
...
Tack för att du bidrar till World of Aphasya. Vi kan inte vänta på att få se
