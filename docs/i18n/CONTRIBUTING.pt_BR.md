...
# Contribuindo com o World of Aphasya

Antes de tudo, obrigado por estar aqui. O World of Aphasya é construído por
...
pergunte no [Discord](https://discord.com/invite/worldofaphasya) e alguém terá o maior prazer
em ajudar.
...
- **Relatos de bug e ideias de recursos.** Abra uma [issue](https://github.com/mgocbr3/world-of-aphasya/issues/new/choose).
...
O World of Aphasya é publicado em vários idiomas. Toda string visível ao
...
inicie uma thread no [Discord](https://discord.com/invite/worldofaphasya) e nós te ajudamos a
...
Por favor, use os [modelos de issue](https://github.com/mgocbr3/world-of-aphasya/issues/new/choose):
...
[Discord da comunidade](https://discord.com/invite/worldofaphasya). Nenhuma pergunta é pequena
...
- ela inclua, no mínimo, uma concessão perpétua e isenta de royalties à Levy
  Street para usar os assets comercialmente no World of Aphasya, incluindo
...
Obrigado por contribuir com o World of Aphasya. Mal podemos esperar para ver o
