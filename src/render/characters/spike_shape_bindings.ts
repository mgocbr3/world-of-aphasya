...
import {
  type SpikeEarringFit,
  spikeEarringFit,
  spikeEarringNode,
} from './spike_earrings_core';
...
export function applySpikeLook(
  ...
  visual.setSpikeEarrings(
    spikeEarringNode(app.earrings),
    earringMaterialSpec(app),
    spikeEarringFit(race, app.gender),
  );
