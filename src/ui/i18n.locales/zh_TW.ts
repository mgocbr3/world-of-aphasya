...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocStore.close': '關閉 Aphasium 商店',
  'hudChrome.wocStore.tabsLabel': 'Aphasium 商店分區',
  'hudChrome.wocStore.storeTab': '商店',
  'hudChrome.wocStore.rewardsTab': '每日獎勵',
  'hudChrome.wocStore.loading': '正在載入 Aphasium 商店…',
  'hudChrome.wocStore.error': 'Aphasium 商店目前無法使用，請稍後再試。',
  'hudChrome.wocStore.balance': 'Aphasium 餘額',
  'hudChrome.wocStore.buyClaudium': '購買 Aphasium',
  'hudChrome.wocStore.owned': '已擁有',
  'hudChrome.wocStore.needMoreTitle': '需要更多 Aphasium',
  'hudChrome.wocStore.needMoreBody': '還需要 {shortfall} Aphasium 才能購買 {item}。',
  'hudChrome.wocStore.cancel': '取消',
  'hudChrome.wocStore.confirmTitle': '確認購買外觀',
  'hudChrome.wocStore.confirmBody': '要用 {cost} Aphasium 購買 {item} 嗎？',
  ...
  'hudChrome.claudium.open': '開啟 Aphasium',
  'hudChrome.claudium.close': '關閉 Aphasium',
  'hudChrome.claudium.loading': '正在載入 Aphasium…',
  'hudChrome.claudium.balanceLabel': '餘額',
  'hudChrome.claudium.balanceUnit': '{amount} Aphasium',
  'hudChrome.claudium.unavailable':
    'Aphasium 商店目前無法使用。您的餘額與購買不受影響，請稍後再試。',
  'hudChrome.claudium.disclosure':
    'Aphasium 是單向軟貨幣：可用金錢購買並用於兌換外觀物品，不能贖回、轉讓或兌現。',
  'hudChrome.claudium.buyTitle': '購買 Aphasium',
  ...
  'hudChrome.claudium.showAmounts': '顯示所有 Aphasium 數量',
  'hudChrome.claudium.hideAmounts': '隱藏其他 Aphasium 數量',
  'hudChrome.claudium.skuRow': '{usd} 可購買 {claudium} Aphasium',
  ...
  'hudChrome.claudium.checkoutUnavailable': '該 Aphasium 購買項目目前無法使用。',
  'hudChrome.claudium.checkoutWalletRequired':
    '使用加密貨幣購買 Aphasium 前，請先連接 Solana 錢包。',
  'hudChrome.claudium.checkoutWalletUnsupported': '此錢包無法簽署及傳送 Solana 交易。',
  'hudChrome.claudium.checkoutNotSettled': '交易已傳送，但 Aphasium 尚未入帳，請稍後再試。',
  ...
  'seo.officialLabel': 'World of Aphasya 官方網站',
  'seo.officialBody':
    'worldofaphasya.com 是 Claudemoon 世界的官方免費瀏覽器 MMO。你可以用持久角色線上遊玩，也可以離線單人探索、閱讀 wiki，並從本站前往已驗證的社群連結。',
  ...
  'wallet.standaloneAppHelp':
    '主畫面應用程式目前尚不支援連接錢包。若要使用 Phantom 或 Solflare，請在 Safari 或 Chrome 中開啟 World of Aphasya。',
  ...
  'wallet.manualReturnStandaloneHelp':
    '核准後請從主畫面返回 World of Aphasya。如果 iOS 開啟了瀏覽器，請將其關閉並重新開啟主畫面 App。',
  ...
  'wallet.browser.safety': 'World of Aphasya 絕不會要求復原短語或私鑰。',
  ...
  'wallet.browser.completeBody': '現在可以返回 World of Aphasya 桌面應用程式。',
  ...
  'playerCard.shareText':
    '我正在 World of Aphasya 中鑄就傳說：{level}級 {className}{tierBit}。加入我的世界：',
  ...
  'controls.chat': '開啟對話框',
  'seo.title': 'World of Aphasya：經典風格網頁 MMO',
  'seo.description':
    '在 World of Aphasya 展開史詩冒險。這是一款可直接在瀏覽器中遊玩的經典風格微型 MMO。加入持續共享的世界，提升職業等級並擊敗敵人！',
  'seo.genre': 'MMORPG',
  'seo.playMode': '多人遊戲',
  ...
  'a11y.githubProject': '開啟 World of Aphasya 的 GitHub 專案',
  'a11y.discordCommunity': '加入 World of Aphasya 的 Discord 社群',
  'a11y.donateProject': '捐贈支持 World of Aphasya',
  'entryGuard.body':
  ...
  'mobilePreflight.iosOpenStep': '從新的主畫面圖示開啟 World of Aphasya。',
  ...
  'mode.play': '開始遊戲',
  'mode.playAria': '遊玩 World of Aphasya',
  ...
  'guide.worldPage.intro': 'World of Aphasya 是一片你要靠雙腳走遍的連續大陸。古道自南向北穿過起始山谷、沼澤和山峰，並越過它們繼續攀升，通向其後的窪地以及地圖頂端的雪境。自那條路向西展開一列更高等級的國度，向東另有一列，谷地東岸外還有一座島嶼。這裡沒有快速旅行，沒有飛行路線，也沒有馬車：每一段路程都靠步行或騎乘完成，所以抵達本身就是冒險的一部分。\n\n這片大地也記錄著時間。晝夜循環依照一只你所在世界人人共享的真實時鐘運轉，因此天空會為你們所有人同時從黎明經正午走向黃昏與夜色，月亮循著盈虧來去，地面上的光影也隨之變化。小地圖周圍的錶盤，就是你讀取時辰的地方。',
  ...
  'hudChrome.nativeUpdate.body':
    'World of Aphasya 有新版本可用。立即更新以取得最新修正與改進。',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'World of Aphasya {version} 版本已可用。立即更新以取得最新修正與改進。',
  ...
  'desktop.notify.updateReadyBody': '重新啟動 World of Aphasya 以套用更新。',
  ...
  'desktop.crash.fatalBody': 'World of Aphasya 發生未預期的錯誤，必須關閉。',
  ...
  'editor.docTitle': '地圖編輯器 - World of Aphasya',
  ...
  'hudChrome.wiki.confirmBody': '將在瀏覽器中開啟 World of Aphasya 維基，遊戲會繼續執行。',
  ...
  'hudChrome.reliquary.sourceStore': '在 Aphasium 商店購買',
  ...
  'guide.faqPage.a12':
    '有一家選擇性的外觀商店。它販售的是造型：以商店貨幣 Aphasium 購買的第一賽季兵器庫武器外觀。裡頭沒有任何東西會增加屬性、力量或進度，外觀也絕不會改變你的武器如何命中，因此每一件真正要緊的裝備，仍然來自遊玩。',
  'guide.faqPage.a13':
  ...
  'guide.glossary.claudiumDef': 'Aphasium 商店的貨幣，只花在外觀上，別無他用。它絕不會買到力量或進度。',
  ...
  'hudChrome.perf.diagnostics.panelAria': 'World of Aphasya 效能診斷',
  'hudChrome.perf.diagnostics.title': 'Aphasya 效能醫生',
  ...
  'hudChrome.perf.diagnostics.report.title': 'World of Aphasya 效能診斷',
