...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocStore.title': 'Aphasium 商店',
  'hudChrome.wocStore.close': '关闭 Aphasium 商店',
  'hudChrome.wocStore.tabsLabel': 'Aphasium 商店分区',
  'hudChrome.wocStore.storeTab': '商店',
  'hudChrome.wocStore.rewardsTab': '每日奖励',
  'hudChrome.wocStore.loading': '正在加载 Aphasium 商店…',
  'hudChrome.wocStore.error': 'Aphasium 商店暂时不可用，请稍后再试。',
  'hudChrome.wocStore.balance': 'Aphasium 余额',
  'hudChrome.wocStore.buyClaudium': '购买 Aphasium',
  'hudChrome.wocStore.owned': '已拥有',
  'hudChrome.wocStore.needMoreTitle': '需要更多 Aphasium',
  'hudChrome.wocStore.needMoreBody': '还需要 {shortfall} Aphasium 才能购买 {item}。',
  'hudChrome.wocStore.cancel': '取消',
  'hudChrome.wocStore.confirmTitle': '确认购买外观',
  'hudChrome.wocStore.confirmBody': '要用 {cost} Aphasium 购买 {item} 吗？',
  ...
  'hudChrome.wocStore.wallet.linkedConnected': '已绑定的钱包应用已连接，可以使用 SOL 或 Aphasium 购买。',
  ...
  'hudChrome.claudium.open': '打开 Aphasium',
  'hudChrome.claudium.close': '关闭 Aphasium',
  'hudChrome.claudium.loading': '正在加载 Aphasium…',
  'hudChrome.claudium.balanceLabel': '余额',
  'hudChrome.claudium.balanceUnit': '{amount} Aphasium',
  'hudChrome.claudium.unavailable':
    'Aphasium 商店暂时不可用。您的余额和购买不会受到影响，请稍后再试。',
  'hudChrome.claudium.disclosure':
    'Aphasium 是单向软货币：可用真钱购买并用于兑换外观物品，不能赎回、转让或兑现。',
  'hudChrome.claudium.buyTitle': '购买 Aphasium',
  ...
  'hudChrome.claudium.showAmounts': '显示所有 Aphasium 数量',
  'hudChrome.claudium.hideAmounts': '隐藏其他 Aphasium 数量',
  'hudChrome.claudium.skuRow': '{usd} 可购买 {claudium} Aphasium',
  ...
  'hudChrome.claudium.checkoutUnavailable': '该 Aphasium 购买项目暂时不可用。',
  'hudChrome.claudium.checkoutWalletRequired':
    '使用加密货币购买 Aphasium 前，请先连接 Solana 钱包。',
  'hudChrome.claudium.checkoutWalletUnsupported': '此钱包无法签署和发送 Solana 交易。',
  'hudChrome.claudium.checkoutNotSettled': '交易已发送，但 Aphasium 尚未到账，请稍后重试。',
  ...
  'seo.officialLabel': 'World of Aphasya 官方网站',
  'seo.officialBody':
    'worldofaphasya.com 是 Claudemoon 世界的官方免费浏览器 MMO。你可以用持久角色在线游玩，也可以离线单人探索，阅读 wiki，并从本站访问已验证的社区链接。',
  ...
  'wallet.standaloneAppHelp':
    '主屏幕应用暂不支持连接钱包。若要使用 Phantom 或 Solflare，请在 Safari 或 Chrome 中打开 World of Aphasya。',
  ...
  'wallet.manualReturnStandaloneHelp':
    '批准后请从主屏幕返回 World of Aphasya。如果 iOS 打开了浏览器，请将其关闭并重新打开主屏幕应用。',
  ...
  'wallet.browser.safety': 'World of Aphasya 绝不会索要助记词或私钥。',
  ...
  'wallet.browser.completeBody': '现在可以返回 World of Aphasya 桌面应用。',
  ...
  'playerCard.defaultRealm': 'Aphasya 世界',
  ...
  'playerCard.shareText':
    '我正在 World of Aphasya 中铸就传说：{level}级 {className}{tierBit}。加入我的世界：',
  'playerCard.nativeShareTitle': 'Aphasya 世界',
  ...
  'controls.chat': '打开聊天框',
  'seo.title': 'World of Aphasya：经典风格网页 MMO',
  'seo.description':
    '在 World of Aphasya 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的世界，提升职业等级，击败敌人！',
  'seo.genre': 'MMORPG',
  'seo.playMode': '多人游戏',
  ...
  'a11y.githubProject': '打开 World of Aphasya 的 GitHub 项目',
  'a11y.discordCommunity': '加入 World of Aphasya 的 Discord 社区',
  'a11y.donateProject': '捐赠支持 World of Aphasya',
  'entryGuard.body':
  ...
  'mobilePreflight.iosOpenStep': '从新的主屏幕图标打开 World of Aphasya。',
  ...
  'mode.play': '开始游戏',
  'mode.playAria': '开始游玩 World of Aphasya',
  ...
  'guide.worldPage.intro': 'World of Aphasya 是一片你要靠双脚走遍的连续大陆。古道自南向北穿过起始山谷、沼泽和山峰，并越过它们继续攀升，通向其后的洼地以及地图顶端的雪境。自那条路向西展开一列更高等级的国度，向东另有一列，谷地东岸外还有一座岛屿。这里没有快速旅行，没有飞行路线，也没有马车：每一段路程都靠步行或骑乘完成，所以抵达本身就是冒险的一部分。\n\n这片大地也记录着时间。昼夜循环依照一只你所在世界人人共享的真实时钟运转，因此天空会为你们所有人同时从黎明经正午走向黄昏与夜色，月亮循着盈亏来去，地面上的光影也随之变化。小地图周围的表盘，就是你读取时辰的地方。',
  ...
  'hudChrome.nativeUpdate.body':
    'World of Aphasya 有新版本可用。立即更新以获取最新修复和改进。',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'World of Aphasya {version} 版本已可用。立即更新以获取最新修复和改进。',
  ...
  'desktop.notify.updateReadyBody': '重启 World of Aphasya 以应用更新。',
  ...
  'desktop.crash.fatalBody': 'World of Aphasya 遇到意外错误，需要关闭。',
  ...
  'editor.docTitle': '地图编辑器 - World of Aphasya',
  ...
  'hudChrome.wiki.confirmBody': '将在浏览器中打开 World of Aphasya 维基，游戏会继续运行。',
  ...
  'hudChrome.reliquary.sourceStore': '在 Aphasium 商店购买',
  ...
  'guide.faqPage.a12':
    '有一个可选的外观商店。它只卖模样：第一赛季兵器库的武器皮肤，用商店货币 Aphasium 购买。里面没有任何东西会增加属性、战力或进度，一款皮肤也绝不会改变你的武器如何打出伤害，所以每一件真正要紧的装备，依然只来自游玩本身。',
  'guide.faqPage.a13':
  ...
  'guide.glossary.claudiumDef': 'Aphasium 商店的货币，只花在外观上，别无他用。它绝不购买战力或进度。',
  ...
  'hudChrome.perf.diagnostics.panelAria': 'World of Aphasya 性能诊断',
  'hudChrome.perf.diagnostics.title': 'Aphasya 性能医生',
  ...
  'hudChrome.perf.diagnostics.report.title': 'World of Aphasya 性能诊断',
