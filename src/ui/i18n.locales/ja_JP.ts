...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocStore.title': 'Aphasiumストア',
  'hudChrome.wocStore.close': 'Aphasiumストアを閉じる',
  'hudChrome.wocStore.tabsLabel': 'Aphasiumストアのセクション',
  'hudChrome.wocStore.storeTab': 'ストア',
  'hudChrome.wocStore.rewardsTab': 'デイリー報酬',
  'hudChrome.wocStore.loading': 'Aphasiumストアを読み込み中…',
  'hudChrome.wocStore.error': 'Aphasiumストアは現在利用できません。しばらくしてからお試しください。',
  'hudChrome.wocStore.balance': 'Aphasium残高',
  'hudChrome.wocStore.buyClaudium': 'Aphasiumを購入',
  'hudChrome.wocStore.owned': '所有済み',
  'hudChrome.wocStore.needMoreTitle': 'Aphasiumが不足しています',
  'hudChrome.wocStore.needMoreBody': '{item}の購入にはあと{shortfall} Aphasium必要です。',
  'hudChrome.wocStore.cancel': 'キャンセル',
  'hudChrome.wocStore.confirmTitle': '外見の購入を確認',
  'hudChrome.wocStore.confirmBody': '{item}を{cost} Aphasiumで購入しますか？',
  ...
  'hudChrome.claudium.open': 'Aphasiumを開く',
  'hudChrome.claudium.close': 'Aphasiumを閉じる',
  'hudChrome.claudium.loading': 'Aphasiumを読み込み中…',
  'hudChrome.claudium.balanceLabel': '残高',
  'hudChrome.claudium.balanceUnit': '{amount} Aphasium',
  'hudChrome.claudium.unavailable':
    'Aphasiumストアは現在利用できません。残高と購入内容に影響はありません。しばらくしてからお試しください。',
  'hudChrome.claudium.disclosure':
    'Aphasiumは一方向のゲーム内通貨です。現金で購入して外見アイテムに使用でき、換金、譲渡、払い戻しはできません。',
  'hudChrome.claudium.buyTitle': 'Aphasiumを購入',
  ...
  'hudChrome.claudium.showAmounts': 'すべてのAphasium数量を表示',
  'hudChrome.claudium.hideAmounts': '追加のAphasium数量を隠す',
  'hudChrome.claudium.skuRow': '{usd}で{claudium} Aphasium',
  ...
  'wallet.standaloneAppHelp':
    'ホーム画面アプリでは、まだウォレットに接続できません。Phantom または Solflare を使用するには、Safari か Chrome で World of Aphasya を開いてください。',
  ...
  'wallet.manualReturnStandaloneHelp':
    '承認後、ホーム画面から World of Aphasya に戻ってください。iOS でブラウザが開いた場合は閉じ、ホーム画面のアプリをもう一度開いてください。',
  ...
  'wallet.browser.safety':
    'World of Aphasyaがリカバリーフレーズや秘密鍵を求めることはありません。',
  ...
  'wallet.browser.completeBody': 'World of Aphasyaデスクトップアプリに戻れます。',
  ...
  'playerCard.defaultRealm': 'Aphasyaの世界',
  ...
  'playerCard.shareText':
    'World of Aphasyaで伝説を鍛えています: レベル{level} {className}{tierBit}。私のワールドに参加してください:',
  'playerCard.nativeShareTitle': 'Aphasyaの世界',
  ...
  'seo.title': 'World of Aphasya: クラシック風Web MMO',
  'seo.description':
    'ブラウザで直接遊べるクラシック風マイクロMMO、World of Aphasya で壮大な冒険に出ましょう。永続的な共有ワールドに参加し、クラスを育て、敵を倒してください。',
  'seo.genre': 'MMORPG',
  ...
  'a11y.githubProject': 'GitHubでWorld of Aphasyaプロジェクトを開く',
  'a11y.discordCommunity': 'World of AphasyaのDiscordコミュニティに参加',
  'a11y.donateProject': 'World of Aphasyaを支援するために寄付',
  'entryGuard.body':
  ...
  'mobilePreflight.iosOpenStep': '新しいホーム画面アイコンからWorld of Aphasyaを開きます。',
  ...
  'mobilePreflight.androidOpenStep': '新しいアイコンからWorld of Aphasyaを開きます。',
  ...
  'serverUnavailable.title': 'World of Aphasya - ワールド利用不可',
  ...
  'mode.play': 'プレイ',
  'mode.playAria': 'World of Aphasyaをプレイ',
  ...
  'guide.worldPage.intro': 'World of Aphasyaは、徒歩で渡っていく、ひと続きの大地です。古い街道は南から北へ、始まりの谷、湿地、山嶺を貫き、その先の窪地と地図の北端の雪国へと登り続けます。その街道からは西へ高位の領邦がひと連なり、東にもうひと連なり開けており、ヴェイルの東岸沖には島が浮かんでいます。高速移動はなく、飛行路も馬車もありません。どの道のりも歩くか騎乗するかで進むので、たどり着くことそのものが冒険の一部です。\n\n大地は時も刻みます。昼夜の周期は、あなたのワールドにいる全員が共有する実際の時計で進むので、空は皆にとって同時に夜明けから正午、そして黄昏と闇へと移り変わり、月は満ち欠けを巡り、地上の光もそれにつれて変わります。ミニマップを囲む文字盤が、時刻を読み取る場所です。',
  ...
  'hudChrome.nativeUpdate.body':
    'World of Aphasya の新しいバージョンが利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'World of Aphasya のバージョン {version} が利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。',
  ...
  'desktop.notify.updateReadyBody': 'アップデートを適用するには World of Aphasya を再起動してください。',
  ...
  'desktop.crash.fatalBody': 'World of Aphasya で予期しないエラーが発生したため、終了します。',
  ...
  'editor.docTitle': 'マップエディター - World of Aphasya',
  ...
  'hudChrome.wiki.confirmBody':
    'World of Aphasya のWikiをブラウザで開きます。ゲームはそのまま続行されます。',
  ...
  'hudChrome.reliquary.sourceStore': 'Aphasiumストアで購入',
  ...
  'guide.faqPage.a12': '任意の装飾ストアがあります。売っているのは見た目だけです。シーズン1武器庫の武器スキンを、ストア通貨のAphasiumで購入できます。ステータスや強さ、進行を足すものは一つもなく、スキンが武器の当たり方を変えることもありません。意味のある装備はすべて、これまでどおり遊ぶことで手に入ります。',
  ...
  'guide.glossary.claudiumDef': 'Aphasiumストアの通貨で、装飾品にしか使えません。強さや進行を買うことは決してありません。',
  ...
  'hudChrome.perf.diagnostics.panelAria': 'World of Aphasya パフォーマンス診断',
  'hudChrome.perf.diagnostics.title': 'Aphasya パフォーマンス診断',
  ...
  'hudChrome.perf.diagnostics.report.title': 'World of Aphasya パフォーマンス診断',
