...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.glossary.claudiumTerm': 'Aphasium',
  ...
  'hudChrome.wocStore.title': 'Aphasium 상점',
  'hudChrome.wocStore.close': 'Aphasium 상점 닫기',
  'hudChrome.wocStore.tabsLabel': 'Aphasium 상점 구역',
  'hudChrome.wocStore.storeTab': '상점',
  'hudChrome.wocStore.rewardsTab': '일일 보상',
  'hudChrome.wocStore.loading': 'Aphasium 상점 불러오는 중…',
  'hudChrome.wocStore.error': '현재 Aphasium 상점을 이용할 수 없습니다. 잠시 후 다시 시도해 주세요.',
  'hudChrome.wocStore.balance': 'Aphasium 잔액',
  'hudChrome.wocStore.buyClaudium': 'Aphasium 구매',
  'hudChrome.wocStore.owned': '보유 중',
  'hudChrome.wocStore.needMoreTitle': 'Aphasium이 더 필요합니다',
  'hudChrome.wocStore.needMoreBody': '{item} 구매에 Aphasium {shortfall}개가 더 필요합니다.',
  'hudChrome.wocStore.cancel': '취소',
  'hudChrome.wocStore.confirmTitle': '꾸미기 상품 구매 확인',
  'hudChrome.wocStore.confirmBody': '{item}을(를) {cost} Aphasium으로 구매할까요?',
  ...
  'hudChrome.claudium.title': 'Aphasium',
  'hudChrome.claudium.open': 'Aphasium 열기',
  'hudChrome.claudium.close': 'Aphasium 닫기',
  'hudChrome.claudium.loading': 'Aphasium 불러오는 중…',
  'hudChrome.claudium.balanceLabel': '잔액',
  'hudChrome.claudium.balanceUnit': '{amount} Aphasium',
  'hudChrome.claudium.unavailable':
    '현재 Aphasium 상점을 이용할 수 없습니다. 잔액과 구매 내역에는 영향이 없으니 잠시 후 다시 확인해 주세요.',
  'hudChrome.claudium.disclosure':
    'Aphasium은 단방향 게임 화폐입니다. 현금으로 구매해 꾸미기 상품에 사용할 수 있으며 환전, 양도 또는 현금화할 수 없습니다.',
  'hudChrome.claudium.buyTitle': 'Aphasium 구매',
  ...
  'hudChrome.claudium.showAmounts': '모든 Aphasium 수량 표시',
  'hudChrome.claudium.hideAmounts': '추가 Aphasium 수량 숨기기',
  'hudChrome.claudium.skuRow': '{usd}에 {claudium} Aphasium',
  ...
  'hudChrome.claudium.storeCost': '{amount} Aphasium',
  ...
  'hudChrome.claudium.checkoutUnavailable': '해당 Aphasium 구매는 현재 이용할 수 없습니다.',
  'hudChrome.claudium.checkoutWalletRequired':
    '암호화폐로 Aphasium을 구매하기 전에 Solana 지갑을 연결하세요.',
  'hudChrome.claudium.checkoutWalletUnsupported':
    '이 지갑은 Solana 거래에 서명하거나 전송할 수 없습니다.',
  'hudChrome.claudium.checkoutNotSettled':
    '거래는 전송됐지만 Aphasium이 아직 지급되지 않았습니다. 잠시 후 다시 시도해 주세요.',
  ...
  'seo.officialLabel': 'World of Aphasya 공식 웹사이트',
  'seo.officialBody':
    'worldofaphasya.com은 Claudemoon 월드의 공식 무료 브라우저 MMO입니다. 지속 캐릭터로 온라인 플레이를 하거나, 오프라인에서 혼자 탐험하고, 위키를 읽고, 이 사이트에서 검증된 커뮤니티 링크를 확인하세요.',
  ...
  'footer.copyright': '2026 World of Aphasya',
  'footer.githubLink': 'https://github.com/mgocbr3/world-of-aphasya',
  ...
  'wallet.standaloneAppHelp':
    '홈 화면 앱에서는 아직 지갑 연결을 사용할 수 없습니다. Phantom 또는 Solflare를 사용하려면 Safari나 Chrome에서 World of Aphasya를 여세요.',
  ...
  'wallet.manualReturnStandaloneHelp':
    '승인 후 홈 화면에서 World of Aphasya로 돌아오세요. iOS에서 브라우저가 열리면 닫고 홈 화면 앱을 다시 여세요.',
  ...
  'wallet.browser.safety': 'World of Aphasya는 복구 문구나 개인 키를 요청하지 않습니다.',
  ...
  'wallet.browser.completeBody': 'World of Aphasya 데스크톱 앱으로 돌아갈 수 있습니다.',
  ...
  'playerCard.defaultRealm': 'Aphasya의 세계',
  'playerCard.brandWordmark': 'WORLD OF APHASYA',
  ...
  'playerCard.shareText':
    'World of Aphasya에서 제 전설을 벼리고 있습니다: {level}레벨 {className}{tierBit}. 제 월드에 합류하세요:',
  'playerCard.nativeShareTitle': 'Aphasya의 세계',
  ...
  'seo.title': 'World of Aphasya: 클래식 스타일 웹 MMO',
  'seo.description':
    '브라우저에서 바로 즐기는 클래식 스타일 마이크로 MMO, World of Aphasya에서 장대한 모험을 시작하세요. 지속되는 공유 월드에 접속해 직업을 성장시키고 적을 물리치세요.',
  'seo.genre': 'MMORPG',
  'seo.playMode': '멀티플레이어',
  ...
  'a11y.githubProject': 'GitHub에서 World of Aphasya 프로젝트 열기',
  'a11y.discordCommunity': 'World of Aphasya Discord 커뮤니티 참여',
  'a11y.donateProject': 'World of Aphasya 후원하기',
  'entryGuard.body':
  ...
  'mobilePreflight.iosOpenStep': '새 홈 화면 아이콘에서 World of Aphasya를 여세요.',
  ...
  'mobilePreflight.androidOpenStep': '새 아이콘에서 World of Aphasya를 여세요.',
  ...
  'serverUnavailable.title': 'World of Aphasya - 월드 이용 불가',
  'serverUnavailable.logoAlt': 'World of Aphasya',
  ...
  'mode.play': '플레이',
  'mode.playAria': 'World of Aphasya 플레이',
  ...
  'guide.brand': 'World of Aphasya',
  'guide.brandShort': 'Aphasya',
  ...
  'guide.worldPage.intro': 'World of Aphasya는 당신이 두 발로 가로지르는 하나로 이어진 땅입니다. 옛 길은 남쪽에서 북쪽으로 시작의 골짜기와 늪지와 봉우리를 꿰뚫고, 그것들을 지나 그 너머의 분지와 지도 꼭대기의 눈의 땅까지 계속 올라갑니다. 그 길에서 서쪽으로 더 높은 왕국들이 한 줄, 동쪽으로 또 한 줄 열리고, 밸리의 동쪽 해안 앞바다에는 섬이 하나 놓여 있습니다. 빠른 이동도, 비행 경로도, 마차도 없습니다. 모든 여정은 걷거나 타고 가는 것이므로, 다다르는 일 자체가 모험의 일부입니다.\n\n이 땅은 시간도 셉니다. 낮과 밤의 순환은 당신의 세계에 있는 모두가 함께 쓰는 실제 시계로 돌아가므로, 하늘은 여러분 모두에게 동시에 새벽에서 한낮을 지나 황혼과 어둠으로 옮겨가고, 달은 차고 기울며 오가고, 땅 위의 빛도 그에 따라 바뀝니다. 미니맵을 두른 눈금판이 시각을 읽는 곳입니다.',
  ...
  'hudChrome.discord.panelTitle': 'World of Aphasya',
  ...
  'hudChrome.nativeUpdate.body':
    'World of Aphasya의 새 버전을 사용할 수 있습니다. 지금 업데이트하여 최신 수정 사항과 개선 사항을 받으세요.',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'World of Aphasya 버전 {version}을(를) 사용할 수 있습니다. 지금 업데이트하여 최신 수정 사항과 개선 사항을 받으세요.',
  ...
  'editor.docTitle': '맵 편집기 - World of Aphasya',
  ...
  'hudChrome.wiki.confirmBody':
    'World of Aphasya 위키를 브라우저에서 엽니다. 게임은 계속 실행됩니다.',
  ...
  'hudChrome.reliquary.sourceStore': 'Aphasium 상점에서 구매',
  ...
  'guide.faqPage.a12': '선택 사항인 꾸미기 상점이 있습니다. 파는 것은 오직 겉모습뿐입니다. 상점 화폐인 Aphasium으로 사는 시즌 1 무기고의 무기 스킨이지요. 그 안에는 능력치나 힘, 성장을 더해 주는 것이 하나도 없고 스킨이 무기의 타격을 바꾸는 일도 없으므로, 실제로 중요한 장비는 여전히 전부 플레이에서 나옵니다.',
  ...
  'guide.glossary.claudiumDef': 'Aphasium 상점의 화폐로, 꾸미기 상품에만 쓰이며 그 밖의 무엇에도 쓰이지 않습니다. 힘이나 성장은 결코 살 수 없습니다.',
  ...
  'hudChrome.perf.diagnostics.panelAria': 'World of Aphasya 성능 진단',
  'hudChrome.perf.diagnostics.title': 'Aphasya 성능 진단',
  ...
  'hudChrome.perf.diagnostics.report.title': 'World of Aphasya 성능 진단',
