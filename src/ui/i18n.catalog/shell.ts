...
export const shellStrings = {
  en: {
    seo: {
      title: 'World of Aphasya: Classic-Style Web MMO',
      description:
        'Embark on an epic adventure in World of Aphasya, a classic-style micro-MMO playable directly in your browser. Join a persistent shared world, level up classes, and defeat enemies!',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Open the World of Aphasya GitHub project',
      discordCommunity: 'Join the World of Aphasya Discord community',
      donateProject: 'Donate to support World of Aphasya',
    },
    entryGuard: {
    ...
    desktop: {
      ...
      notify: {
        ...
        updateReadyBody: 'Restart World of Aphasya to apply the update.',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Open World of Aphasya from the new Home Screen icon.',
      ...
      androidOpenStep: 'Open World of Aphasya from the new icon.',
    ...
    serverUnavailable: {
      title: 'World of Aphasya - World Unavailable',
  ...
  es: {
    seo: {
      title: 'World of Aphasya: MMO web de estilo clásico',
      description:
        'Emprende una aventura épica en World of Aphasya, un micro-MMO de estilo clásico que se juega directamente en el navegador. Entra a un reino compartido, sube de nivel y derrota enemigos.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Abrir el proyecto de World of Aphasya en GitHub',
      discordCommunity: 'Unirse a la comunidad de World of Aphasya en Discord',
      donateProject: 'Donar para apoyar World of Aphasya',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Abre World of Aphasya desde el nuevo icono de la pantalla de inicio.',
      ...
      androidOpenStep: 'Abre World of Aphasya desde el nuevo icono.',
    ...
    serverUnavailable: {
      title: 'World of Aphasya - Reino no disponible',
      logoAlt: 'World of Aphasya',
  ...
  es_ES: {
    seo: {
      title: 'World of Aphasya: MMO web de estilo clásico',
      description:
        'Emprende una aventura épica en World of Aphasya, un micro-MMO de estilo clásico jugable directamente en el navegador. Únete a un reino compartido, sube clases de nivel y derrota enemigos.',
      genre: 'MMORPG',
      playMode: 'Multijugador',
      applicationCategory: 'Juego',
      operatingSystem: 'Navegador web',
    ...
    a11y: {
      ...
      githubProject: 'Abrir el proyecto World of Aphasya en GitHub',
      discordCommunity: 'Unirse a la comunidad de World of Aphasya en Discord',
      donateProject: 'Donar para apoyar World of Aphasya',
    },
    loading: {
  ...
  fr_FR: {
    seo: {
      title: 'World of Aphasya: MMO web de style classique',
      description:
        'Partez pour une aventure épique dans World of Aphasya, un micro-MMO au style classique jouable directement dans votre navigateur. Rejoignez un royaume persistant, progressez en classe et terrassez vos ennemis.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Ouvrir le projet World of Aphasya sur GitHub',
      discordCommunity: 'Rejoindre la communauté World of Aphasya sur Discord',
      donateProject: 'Faire un don pour soutenir World of Aphasya',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Ouvrez World of Aphasya depuis la nouvelle icône de l'écran d'accueil.",
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Ouvrez World of Aphasya depuis la nouvelle icône.',
    ...
    serverUnavailable: {
      title: 'World of Aphasya - Royaume indisponible',
      logoAlt: 'World of Aphasya',
  ...
  fr_CA: {
    seo: {
      title: 'World of Aphasya: MMO Web de style classique',
      description:
        "Partez à l'aventure dans World of Aphasya, un micro-MMO de style classique jouable directement dans votre navigateur. Rejoignez un royaume partagé, faites progresser vos classes et terrassez des ennemis.",
      genre: 'MMORPG',
      playMode: 'Multijoueur',
      applicationCategory: 'Jeu',
      operatingSystem: 'Navigateur Web',
  ...
  en_CA: {
    seo: {
      title: 'World of Aphasya: Classic-Style Web MMO',
      description:
        'Embark on an epic adventure in World of Aphasya, a classic-style micro-MMO playable directly in your browser. Join a persistent shared realm, level up classes, and defeat enemies!',
      genre: 'MMORPG',
      playMode: 'Multiplayer',
      applicationCategory: 'Game',
      operatingSystem: 'Web browser',
    ...
    serverUnavailable: {
      title: 'World of Aphasya - Realm Unavailable',
      logoAlt: 'World of Aphasya',
  ...
  it_IT: {
    seo: {
      ...
      description:
        "Parti per un'avventura epica in World of Aphasya, un micro-MMO in stile classico giocabile direttamente dal browser. Entra in un reame condiviso, fai crescere le classi e sconfiggi i nemici.",
      genre: 'MMORPG',
    ...
    serverUnavailable: {
      title: 'World of Aphasya - Reame non disponibile',
      logoAlt: 'World of Aphasya',
  ...
  de_DE: {
    seo: {
      title: 'World of Aphasya: Klassisches Web-MMO',
      description:
        'Begib dich in World of Aphasya auf ein episches Abenteuer, ein Micro-MMO im klassischen Stil direkt im Browser. Betritt einen gemeinsamen Realm, steigere Klassen und besiege Gegner.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'World of Aphasya-Projekt auf GitHub öffnen',
      discordCommunity: 'Der World of Aphasya-Community auf Discord beitreten',
      donateProject: 'Spenden, um World of Aphasya zu unterstützen',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Öffne World of Aphasya über das neue Symbol auf dem Home-Bildschirm.',
      ...
      androidOpenStep: 'Öffne World of Aphasya über das neue Symbol.',
    ...
    serverUnavailable: {
      title: 'World of Aphasya - Realm nicht verfügbar',
      logoAlt: 'World of Aphasya',
  ...
  zh_CN: {
    seo: {
      ...
      description:
        '在 World of Aphasya 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的服务器，提升职业等级，击败敌人。',
      genre: 'MMORPG',
      playMode: '多人游戏',
  ...
  zh_TW: {
    seo: {
      title: 'World of Aphasya：經典風格網頁 MMO',
      description:
        '在 World of Aphasya 展開史詩冒險。這是一款可直接在瀏覽器中遊玩的經典風格微型 MMO。加入持續共享的伺服器，提升職業等級並擊敗敵人。',
      genre: 'MMORPG',
      playMode: '多人遊戲',
    ...
    a11y: {
      ...
      characterActions: '角色操作',
      githubProject: '開啟 World of Aphasya 的 GitHub 專案',
      discordCommunity: '加入 World of Aphasya 的 Discord 社群',
      donateProject: '捐贈支持 World of Aphasya',
    },
    loading: {
      world: '正在載入世界...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '從新的主畫面圖示開啟 World of Aphasya。',
  ...
  ko_KR: {
    seo: {
      ...
      description:
        '브라우저에서 바로 즐기는 클래식 스타일 마이크로 MMO, World of Aphasya에서 장대한 모험을 시작하세요. 지속되는 공유 렐름에 접속해 직업을 성장시키고 적을 물리치세요.',
      genre: 'MMORPG',
      playMode: '멀티플레이어',
    ...
    serverUnavailable: {
      title: 'World of Aphasya - 렐름 이용 불가',
      logoAlt: 'World of Aphasya',
      eyebrow: '렐름 점검',
  ...
  ja_JP: {
    seo: {
      title: 'World of Aphasya: クラシック風Web MMO',
      description:
        'ブラウザで直接遊べるクラシック風マイクロMMO、World of Aphasya で壮大な冒険に出ましょう。永続的な共有レルムに参加し、クラスを育て、敵を倒してください。',
      genre: 'MMORPG',
      playMode: 'マルチプレイヤー',
    ...
    a11y: {
      ...
      githubProject: 'GitHubでWorld of Aphasyaプロジェクトを開く',
      discordCommunity: 'World of AphasyaのDiscordコミュニティに参加',
      donateProject: 'World of Aphasyaを支援するために寄付',
    },
    loading: {
      world: '世界を読み込み中...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '新しいホーム画面アイコンからWorld of Aphasyaを開きます。',
  ...
  pt_BR: {
    seo: {
      title: 'World of Aphasya: MMO web em estilo clássico',
      description:
        'Embarque em uma aventura épica em World of Aphasya, um micro-MMO de estilo clássico jogável diretamente no navegador. Entre em um reino compartilhado, evolua classes e derrote inimigos.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Abrir o projeto World of Aphasya no GitHub',
      discordCommunity: 'Entrar na comunidade World of Aphasya no Discord',
      donateProject: 'Doar para apoiar World of Aphasya',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Abra World of Aphasya pelo novo ícone na tela inicial.',
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Abra World of Aphasya pelo novo ícone.',
    ...
    serverUnavailable: {
      title: 'World of Aphasya - Reino indisponível',
      logoAlt: 'World of Aphasya',
  ...
  ru_RU: {
    seo: {
      ...
      description:
        'Отправьтесь в эпическое приключение в World of Aphasya, микро-MMO в классическом стиле прямо в браузере. Присоединяйтесь к общему миру, развивайте классы и побеждайте врагов.',
      genre: 'MMORPG',
