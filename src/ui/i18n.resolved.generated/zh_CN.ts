...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      "title": "Aphasium 商店",
      "close": "关闭 Aphasium 商店",
      "tabsLabel": "Aphasium 商店分区",
      "storeTab": "商店",
      "rewardsTab": "每日奖励",
      "loading": "正在加载 Aphasium 商店…",
      "error": "Aphasium 商店暂时不可用，请稍后再试。",
      "balance": "Aphasium 余额",
      ...
      "wallet": {
        ...
        "linkedConnected": "已绑定的钱包应用已连接，可以使用 SOL 或 Aphasium 购买。",
  ...
  "guide": {
    ...
    "glossary": {
      ...
      "claudiumDef": "Aphasium 商店的货币，只花在外观上，别无他用。它绝不购买战力或进度。",
      "worldTerm": "世界",
