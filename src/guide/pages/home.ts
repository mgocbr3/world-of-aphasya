  ...
  return `
    <section class="guide-section guide-community" aria-labelledby="guide-community-h">
      ...
      <div class="guide-community-cta">
        ...
        <a class="guide-cta guide-cta-ghost" href="https://discord.com/invite/worldofaphasya" target="_blank" rel="noopener">${esc(t('guide.home.community.discord'))}</a>
        <a class="guide-cta guide-cta-ghost" href="https://github.com/mgocbr3/world-of-aphasya" target="_blank" rel="noopener">${esc(t('guide.home.community.github'))}</a>
      </div>
    </section>`;
}
